...
if (!$error) {
    ...
    // Usar la clase Usuario para crear un nuevo usuario
    $usuario = new Usuario();
    $resultado = $usuario->nuevoUsuario(filtraCampo($nombre), filtraCampo($apellidos), filtraCampo($username), $contrasena, $rol);
    if ($resultado[0]) {
