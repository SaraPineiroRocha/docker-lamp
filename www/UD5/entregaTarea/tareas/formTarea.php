...
<div class="mb-3">
    ...
    <textarea class="form-control" id="descripcion" name="descripcion" required><?php echo isset($descripcion) ? htmlspecialchars($descripcion) : ''; ?></textarea>
</div>
<div class="mb-3">
...
if (checkAdmin()) {
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="id_usuario" name="id_usuario" required>
            <option value="" <?php echo empty($id_usuario) ? 'selected' : ''; ?> disabled>Seleccione el usuario</option>
            <?php
