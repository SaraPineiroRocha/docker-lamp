            ...
            if (!empty($_GET)) {
                ...
                if (!empty($id)) {
                    if (checkAdmin() || esPropietarioTarea($_SESSION['usuario']['id'], $id)) {
                        ...
                        list($exito, $tarea) = buscaTarea($id);  // Devolverá [true, tarea] o [false, 'mensaje de error']
                        if ($exito) {
                            // Tarea encontrada
                            $usuario = $tarea->getUsuario();  // Obtener el usuario asociado a la tarea
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <p class="mb-0"><?php echo $usuario ? $usuario->getUsername() : 'No disponible'; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            echo '<div class="alert alert-danger" role="alert">' . $tarea . '</div>';
                        }
                    } else {
