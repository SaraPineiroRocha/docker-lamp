...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <?php
            // Ejemplo de cómo usar la clase Tarea para crear objetos
            if (!empty($tareas)) {
                foreach ($tareas as $tareaData) {
                    $tarea = new Tarea($tareaData['id'], $tareaData['titulo'], $tareaData['descripcion'], $tareaData['estado'], null); // Usando Tarea
                    // Ahora puedes usar los métodos de Tarea como $tarea->getTitulo(), etc.
                    echo $tarea->getTitulo(); // Ejemplo de uso
                }
            }
            ?>
